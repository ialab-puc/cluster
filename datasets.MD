...
|---------|-----------|--------|------|------|
|      [AVA Actions 2.2](https://github.com/ialab-puc/cluster/blob/datasets/datasets/ava_actions2_2.MD)  |  /vault/araymond/ava_frames         |   34 Gb (videos), 119 Gb (frames)   |    scylla  | Video | 
